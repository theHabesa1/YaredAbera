            ...
            <div className={styles.asideUser}>
                ...
                <div className={styles.asideUserInfoContainer}>
                    <Link href='/' legacyBehavior>
                        <a className={styles.asideUserName}>Yared Abera</a>
                    </Link>
            ...
            <div className={styles.asideInformation}>
                ...
                <ul className={styles.asideInformationPersonalList}>
                    ...
                    <li className={styles.asideInformationPersonalListItem}>
                        ...
                        <span>{new Date().getFullYear() - 1999}</span>
                    </li>
                </ul>
                ...
                <a href="https://drive.google.com/file/d/1LaJ7vnnotvrU4nzxI2ajqATSVvrWEgsx/view?usp=share_link" className={styles.asideInformationCV}>
                    <CgSoftwareDownload />
