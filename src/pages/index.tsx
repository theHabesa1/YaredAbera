...
const Home: NextPage = (props: any) =>
{
    ...
    return (
        <Fragment>
            <Head>
                <title>Yared Ab &mdash; Full-Stack Developer</title>
            </Head>
...
{
    const repositories = await axios.get('https://api.github.com/users/theHabesa1/repos');
    const organizations = await axios.get('https://api.github.com/users/theHabesa1/orgs');
