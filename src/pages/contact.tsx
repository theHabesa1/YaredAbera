    ...
    return (
        <Fragment>
            <Head>
                ...
                <title>Yared Abera &mdash; Contact with me</title>
            </Head>
                ...
                <div className={styles.contactCards}>
                    ...
                    <div className={styles.contactCardsCard}>
                        <ul className={styles.contactCardsCardList}>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Gmail:</span>
                                <a href="mailto:yaredabera215@Gmail.com">Yared Ab</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>ProtonMail:</span>
                                <a href="mailto:yaredabera1@ProtonMail.com">Yared Ab</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Discord:</span>
                                <span>ColeWorld</span>
